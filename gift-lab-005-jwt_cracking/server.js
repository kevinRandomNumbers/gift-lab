...
db.serialize(() => {
  ...
  db.run(`INSERT INTO users (username, password_hash, role) VALUES (?, ?, ?)`, ["administrator", administratorPass, "administrator"]);
  db.run(`INSERT INTO users (username, password_hash, role) VALUES (?, ?, ?)`, ["jeremy", jeremyPass, "user"]);
  // Seed lists
