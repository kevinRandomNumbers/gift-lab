...
## Installation
To run the lab simply run `nmp install`, after the node_modules have been installed, you can run the app with `node server.js`, run `npm run dev` if you need nodemon.
## How to use it
